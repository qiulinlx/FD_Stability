...
tiff_path = "data/disturbance/disturbance_data.tif"
...
df_pid.rename(columns={"raster_value": "disturbance_value"}, inplace=True)

df_pid.to_csv("data/processed/PID_disturbance.csv", index=False)
